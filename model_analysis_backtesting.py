...
if __name__ == '__main__':
    ...
    option_with_feature = pd.read_csv(Path(DATAROOT, f"{data_file}.csv"), nrows=1000000)
    OUTLIER = 2000
    ...
    print(backtesting(test_data, model, used_characteristics))
